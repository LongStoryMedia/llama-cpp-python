    ...
    while True:
        try:
            ...
            if user_input.lower() == 'quit':
                ...
                print("  Example: [IMAGE:https://example.com/image.jpg] What's in this image?")
                continue
            elif not user_input:
                continue
...
def main():
    ...
    if MODEL_PATH == "path/to/your/qwen3-vl-model.gguf":
        print("ERROR: Please update MODEL_PATH and MMPROJ_PATH variables in this script")
        print("       with the actual paths to your Qwen3-VL model files.")
        print()
        print("You can download models from:")
        print("https://huggingface.co/huihui-ai/Huihui-Qwen3-VL-2B-Thinking-abliterated")
        return 1
    ...
    try:
        ...
        print(f"ERROR: {e}")
        print("Please make sure the model files exist and update the paths in this script.")
        return 1
    except Exception as e:
        print(f"ERROR: {e}")
        return 1
